  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col gap-3 items-center">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="w-13 h-13 rounded-full flex items-center justify-center shadow-lg shadow-green-900/30"
      ...
      <div className="relative">
        <span
          ...
          style={{ backgroundColor: "rgba(196,180,154,0.4)" }}
        />
        <motion.a
          href="tel:6907415055"
          ...
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.95 }}
          className="relative w-13 h-13 rounded-full flex items-center justify-center shadow-lg"
          style={{ width: 52, height: 52, backgroundColor: "#C4B49A" }}
        >
